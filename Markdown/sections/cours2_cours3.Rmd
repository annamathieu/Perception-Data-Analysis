...
La question se pose de comment on passe de rang à distance. Il expiste
plein de métriques différents, mais on peut très simplement dire que le
...
minimiser la différence entre distance observée (entre un individu et un
idéal = entre un idéal et un stimuli) et estimées (entre les stimulis
entre eux). On On veut que la distance entre les individus qui ont des
idéaux proches soit faible et qu'un individu représenté par son idéal
soit proche des stimulis proches de son idéal (ceux qui ont été classé
parmi les premiers stimulis pour cet individu).
...
zéro déchet , circuits courts , seconde main (en haut en gauche) -
produits saison, chauffage bas (centre) - outil manuels, covoiturage,
veille appareils, mobilité douce (bas gauche) - sans avion, ia

Le premier cluster semble rassembler des atomic habits correspondant à
des habitudes que des individus se sentant impliqués et responsables de
la réduction de leur empreinte environnementale se sentent capable de
tenir sur le long terme pour réduire le impact sur l'environnement. En
effet, ces habitudes sont des actions choisies, assumées, de choix de
modes de vie et de consommation (devenir végétarien, zéro déchet,
n'acheter que de la seconde main) et qui relèvent de l'identité des
individus. De plus, les modalités 'très responsables' et 'moyennement
responsables' se situent de ce même côté du graphique. Ce groupe
regroupe ainsi des idéaux de personnes engagées, qui se sentent
responsables de leur actions et sont prêtes à de forts changement de
leur mode de vie pour réduire leur impact sur l'environnement.

Le cluster 2 regroupe des atomic habits autour du chauffage (abaisser la
température à son domicile) et de la consommation de produits de saison.
Ils représentent des individus ne sentant peu concernés par les
questions environnementales.

Le cluster 3 regroupe des atomic habits que l'on pourrait qualifier d'un
engagement limité, correspondant à des gestes simples, des adaptations
plus faibles ou passives de leur mode de vie : privilégier la mobilité
douce, mettre en veille les appareils, privilégier l'usage des outils
non électriques, utiliser des systèmes de prêt, etc. Cette idéal est
associé à des individus qui se sentent 'peu responsable' de la baisse de
leur impact environnental, et qui considèrent avec espoir les
transitions environnementales.

Le cluster 4 regroupant avion et pas d'utilisation d'IA regroupe des
idéaux partagés par des individus se sentant 'pas du tout responsables'
de leur action pour baisser leur impact environnementales. Ces individus
peuvent être qualifiés de détachés, ou résignés, car ils ne sentent pas
concernés, et le changement est vécu plus comme une contrainte qu'un
choix.

# D'idéal au Profil idéal
